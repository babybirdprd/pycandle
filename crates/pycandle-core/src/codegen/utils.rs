...
impl super::Codegen {
    ...
    pub fn map_type(&self, py_type: &str) -> String {
        ...
        match py_type {
            ...
            "ConvTranspose1d" => "candle_nn::ConvTranspose1d".to_string(),
            "ParametrizedConvTranspose1d" => "candle_nn::ConvTranspose1d".to_string(),
            "Upsample" => "Upsample".to_string(),
            "ReflectionPad1d" => "ReflectionPad1d".to_string(),
            "SineGen" => "SineGen".to_string(),
